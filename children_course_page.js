...
// Sample data for the chart (you can replace this with actual monitoring data)
const data = [100, 150, 200, 180, 250, 220];
...
// Update the chart with new data (you can call this function with actual data)
...
setInterval(() => {
    const randomData = Math.floor(Math.random() * 300); 
